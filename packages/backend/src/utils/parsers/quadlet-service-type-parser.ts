 ...
 */
export class QuadletServiceTypeParser extends Parser<Options, QuadletServiceTypeParserResult> {
  constructor(content: Options) {
    super(content);
  }

  override parse(): QuadletServiceTypeParserResult {
    ...
    // for simple service
    if (!name.includes('@')) return [ServiceType.SIMPLE, undefined];
